...
💡 **Обратная связь — главное топливо проекта!**
Будь то баг-репорт, идея для вашей студии или просто короткое *"у меня на 5 серверах всё работает"* — пожалуйста, пишите это в **[GitHub Issues](https://github.com/Kotin-ak/VRC-Releases/issues)**. Вся разработка и приоритеты обновлений строятся на базе тикетов в GitHub, а не сообщений в Discord. Любой ваш отзыв критически важен для развития программы!
