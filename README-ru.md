...
- [1. Дашборд](#1-дашборд)
- [2. Управление устройствами vMix](#2-управление-устройствами-vmix)
- [3. Карточка устройства](#3-карточка-устройства)
...
- [4. Мониторинг состояния ПК](#4-мониторинг-состояния-пк-pc-health)
- [5. Настройки трансляции](#5-настройки-трансляции-streaming-settings)
- [6. Планировщик задач](#6-планировщик-задач-task-scheduler)
- [7. Сочетания клавиш](#7-сочетания-клавиш-интеграция-с-внешними-контроллерами)
- [8. Настройки приложения](#8-настройки-приложения)
