...
Будь то баг-репорт, идея для вашей студии или просто короткое *"у меня на 5 серверах всё работает"* — пожалуйста, пишите это в **[GitHub Issues](https://github.com/Kotin-ak/VRC-Releases/issues)**. Вся разработка и приоритеты обновлений строятся на базе тикетов в GitHub.
